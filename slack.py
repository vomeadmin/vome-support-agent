...
CHANNEL_ENGINEERING = os.environ["SLACK_CHANNEL_ENGINEERING"]
CHANNEL_FIELD_FEEDBACK = os.environ["SLACK_CHANNEL_FIELD_FEEDBACK"]
CHANNEL_FEATURE_REQUESTS = os.environ["SLACK_CHANNEL_FEATURE_REQUESTS"]
CHANNEL_AGENT_LOG = os.environ["SLACK_CHANNEL_AGENT_LOG"]
