...
def _extract_task_with_claude(
    ...
    prompt = (
        ...
        "- title: clean, concise task title (max 80 chars). Write it as "
        "a proper task name, not a copy of what the user typed. "
        "Example: user says 'it would be cool to rebrand our website' "
        "-> title: 'Website rebrand'\n"
        "- description: 1-2 sentences describing what needs to be done. "
        "Write as if briefing an engineer or team member. Do NOT "
        "narrate where the request came from or mention Slack/channels. "
        "Do NOT pad with filler. Just the task itself. "
        "Example: 'Rebrand the company website with updated visual "
